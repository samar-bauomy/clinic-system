            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">اضافه وصل نظافه</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                    <a  class="btn btn btn-primary btn-rounded float-right" href="Cleanliness.php"> النظافه </a>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="Cleanliness_name_add" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label> التاريخ <span class="text-danger">*</span></label>
                                        <input class="form-control"  name="Cleanliness_date_add" type="date">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label> القيمه <span class="text-danger">*</span></label>
                                        <input class="form-control" name="Cleanliness_payment_add" type="desimal">
                                    </div>
...
if(isset($_POST["btnsave"]))
{
    ...
    $db=new Database();
     $db->RunDML("insert into Cleanliness values(Default,'".$_POST["Cleanliness_name_add"]."','".$_POST["Cleanliness_date_add"]."','".$_POST["Cleanliness_payment_add"]."')");
...
if(isset($_POST["btnupdate"]))
{
    include_once('Classes/Database.php');
    $db=new Database();
     $db->RunDML("update Cleanliness set id='".$_POST["name_add"]."',name='".$_POST["Cleanliness_name_add"]."',date='".$_POST["Cleanliness_date_add"]."',value='".$_POST["Cleanliness_payment_add"]."'");
...
if(isset($_POST["btndelete"]))
{
    include_once('Classes/Database.php');
    $db=new Database();
     $db->RunDML("delete from Cleanliness where id='".$_POST["name_add"]."'");
...
<?php
    include_once('Classes/Database.php');
    $db=new Database();
    $rsn=$db->GetData("select * from Cleanliness");
