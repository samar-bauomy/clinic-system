...
?>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    ...
                    <a  class="btn btn btn-primary btn-rounded float-right" href="edit-taxes.php">اضافه  فاتوره ضريبه </a>
 ...
 <?php
    ...
    $db=new Database();
    $rs=$db->GetData("SELECT * FROM `taxes`");
...
{
    $db->RunDML("delete from taxes where ID='".$row["id"]."'");
